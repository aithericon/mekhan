...
/// runner injects `set_output` / `log_info`; `_aithericon_io` is generated by
/// the compiler at publish and staged to S3 alongside main.py.
const MAIN_PY: &str = r#"from _aithericon_io import load_input

load_input()
log_info("scheduled automated-step e2e ran")
set_output("ran", True)
