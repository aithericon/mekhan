...
Feed these as the Start node's input payload through `/api/v1/instances` or the web editor. The critic's calibration depends on the model — a smaller LLM may need the prompt tightened to reliably catch the unsafe case.
