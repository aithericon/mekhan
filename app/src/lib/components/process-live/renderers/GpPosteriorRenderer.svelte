...
<div class="flex flex-col gap-3">
	{#if loading}
		<div class="text-sm text-muted-foreground">Loading posterior…</div>
	{:else if error}
		<div class="text-sm text-red-500">{error}</div>
	{:else if model}
		<div class="grid grid-cols-1 gap-3 lg:grid-cols-3">
			<div class="rounded-lg border border-border bg-card p-2">
				<div bind:this={meanEl} class="h-64 w-full"></div>
			</div>
			<div class="rounded-lg border border-border bg-card p-2">
				<div bind:this={stdEl} class="h-64 w-full"></div>
			</div>
			<div class="rounded-lg border border-border bg-card p-2">
				<div bind:this={eiEl} class="h-64 w-full"></div>
			</div>
		</div>
