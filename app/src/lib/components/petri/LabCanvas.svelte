<script lang="ts">
	...
	import type { PetriNet, Token, TransitionStatus, ScenarioGroup, Port } from '$lib/types/petri';
	import type { IssueLevel, ValidationIssue, EventSpotlight, MarkingDiff } from '$lib/types/petri';
