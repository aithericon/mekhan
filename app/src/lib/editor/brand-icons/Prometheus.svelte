<script lang="ts">
	// Prometheus brand mark — vendored from Simple Icons (CC0). slug: prometheus.
	// See Python.svelte for the rendering contract (currentColor, class prop).
...
<svg
	...
	viewBox="0 0 24 24"
	fill="currentColor"
	class={['brand-icon brand-prometheus', className]}
	aria-hidden="true"
>
	<path
