...
<div class="flex h-screen flex-col">
	<header class="flex h-12 shrink-0 items-center border-b border-border bg-card px-4" data-testid="app-header">
		<a
			href="/"
			class="-ml-4 flex self-stretch items-center bg-foreground pl-4 pr-7 text-sm font-semibold uppercase tracking-[0.18em] text-background transition-opacity hover:opacity-90"
			style="clip-path: polygon(0 0, 100% 0, calc(100% - 0.9rem) 100%, 0 100%)"
